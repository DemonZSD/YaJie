...
<form class="layui-form" action="<%=basePath %>/user/userAdd.do" method="POST">
	<div class="layui-form-item">
	    ...
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input type="tel" name="umobile" lay-verify="phone" autocomplete="off" placeholder="请输入手机号" class="layui-input">
	      </div>
	      <span class="require-input">*</span>
	    </div>
 	 </div>	
 	 ...
 	 <div class="layui-form-item">
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input type="tel" name="utelphone" autocomplete="off" placeholder="请输入固话号" class="layui-input">
	      </div>
	      &nbsp;
	    </div>
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input type="tel" name="umobileBak" lay-verify="umobileBak" autocomplete="off" placeholder="请输入手机号" class="layui-input">
	      </div>
	    </div>
 	 </div>	
 	<div class="layui-form-item">
		      ...
		      <select name="companyId" lay-search="">
		        <option value="">请选择所在单位</option>
		      	<c:forEach items="${companyList }" var="companyList">
		      		<option value="${companyList.cid}">${companyList.cname}</option>
		      	</c:forEach>
		      </select>
		    </div>
		  </div>
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="uhomeAddr"  autocomplete="off" placeholder="请输入家庭住址" class="layui-input">
	    </div>
  	</div>
